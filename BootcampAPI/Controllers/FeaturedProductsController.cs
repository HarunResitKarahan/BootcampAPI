...
namespace BootcampAPI.Controllers
{
    ...
    public class FeaturedProductsController : ControllerBase
    {
        ...
        public FeaturedProductsController() => _context = new DBFullStackContext();
        ...
        public async Task<ActionResult<FeaturedProduct>> PostFeaturedProduct(FeaturedProduct featuredProduct)
        {
            ...
            return CreatedAtAction("GetFeaturedProduct", new { id = featuredProduct.FeaturedProductId }, featuredProduct);
        }
        ...
        {
            return _context.FeaturedProducts.Any(e => e.FeaturedProductId == id);
        }
    }
}
